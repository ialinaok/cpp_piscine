...
/*   Updated: 2023/02/13 12:13:00 by apielasz         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "ClapTrap.hpp"

ClapTrap::ClapTrap() : _name((std::string)"Anonym"), _hp(100), _energy(50), _attack_damage(20) {

	std::cout << "ClapTrap default constructor called for " << this->_name << std::endl;
}

ClapTrap::ClapTrap(std::string name) : _name(name), _hp(100), _energy(50), _attack_damage(20) {
