...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2023/03/20 19:09:26 by apielasz          #+#    #+#             */
/*   Updated: 2023/03/20 19:56:35 by apielasz         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
class Pair {
	...
	std::cout << v1 << std::endl;
		T const &	fst(void) const	{return this->_lhs; } //getters to access elements of the pair
